 ...
 */
const sequence = []; // Array untuk menyimpan deret Fibonacci
const result = [];   // Array untuk menampilkan output secara bertahap
...
for (let i = 0; i <= numberForFibonacci; i++) {
  sequence.push(fibonacci(i)); // Tambahkan elemen Fibonacci ke array
